...
fn enable_test_env() {
    ...
    env::set_var("EASYFORMATTER_TEST_DB_PER_THREAD", "1");
}
...
fn delete_single_version_keeps_chain_valid() {
    ...
    assert_eq!(content1, pretty_json(&a));
    assert_eq!(content3, pretty_json(&c));
}
